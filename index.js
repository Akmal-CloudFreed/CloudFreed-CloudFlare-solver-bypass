...
import SolveIUAM from "./lib/IUAM.js";
...
class CloudFreed {
    ...
    try {
      ...
      if (versionInfo.webSocketDebuggerUrl) {
        ...
        return {
          ...
          SolveTurnstile: async () => await this.SolveTurnstile(),
  ...
  async SolveIUAM(url) {
    ...
    const response = await SolveIUAM(this.websocket, url, `file:///${path.join(__dirname, "html", "Loading.html")}`, this.proxy);
    return response;
  }
